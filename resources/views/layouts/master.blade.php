            ...
            <div class="navbar bg-white shadow-md w-full h-16">
                <div
                    ...
                    <div class="menu flex gap-2 invisible md:visible lg:visible">
                        <div
                            class="category flex hover:bg-gradient-to-r hover:from-sky-600 hover:to-blue-600 duration-400 rounded-xl text-slate-500 hover:text-slate-100 py-[6.5px] px-2 gap-[1.4px] items-center">
                        ...
                        <div
                            class="topic flex hover:bg-gradient-to-r hover:from-sky-600 hover:to-blue-600 duration-400 rounded-xl text-slate-500 hover:text-slate-100 py-[6.5px] px-2 gap-[1.4px] items-center">
                            <span class="material-symbols-outlined flex cursor-pointer items-center">
                                topic
                            </span>
                        ...
                        <div
                            class="article flex hover:bg-gradient-to-r hover:from-sky-600 hover:to-blue-600 duration-400 rounded-xl text-slate-500 hover:text-slate-100 py-[6.5px] px-2 gap-[1.4px] items-center">
                            <span class="material-symbols-outlined flex cursor-pointer items-center">
                                article
                            </span>
                        ...
                        <div
                            class="about flex hover:bg-gradient-to-r hover:from-sky-600 hover:to-blue-600 duration-400 rounded-xl text-slate-500 hover:text-slate-100 py-[6.5px] px-2 gap-[1.4px] items-center">
                            <span class="material-symbols-outlined flex cursor-pointer items-center">
                                support
                            </span>
