<aside class="w-80 mt-8 h-full md:hidden hidden lg:block sticky top-24" aria-label="Sidebar">
    <div class="container py-6 pr-4 w-full h-full">
        <div class="title font-bold text-[#031B4E] flex items-center text-xl mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon h-6  fill-red-500" viewBox="0 0 512 512">
                    ...
                    @if ($article->id != $perarticle->id)
                        <li class="p-[1.5px]">
                            <div class="profile-all w-full flex gap-1 items-center mb-1 rounded-l-full rounded-r-2xl">
                                ...
                                <p class="font-semibold text-[#031B4E] text-sm flex gap-1">{{ $perarticle->user->name }}
                                    on
                            ...
                            <div class="title-post font-normal text-sky-900">
